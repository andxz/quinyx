...
add_action('genesis_after_header', function () {
	...
	<section class="page-content-section top-field bg-cover flex-container dark" style="background-image: url(<?= get_field('top_image', 275)['url'] ?>)" title="<?= the_title() ?>">
		
		<div class="top-field__inner flex-child flex-child__center">
				
			<div class="top-field__inner__content white-font">
				
				<h1 class="top-field__inner__content__headline"><?= get_field('top_field_headline', 275) ?></h1>
				
				<?php if( get_field('top_field_text', 275) ) { ?>
					
					<div class="top-field__inner__content__text">
						
						<?= get_field('top_field_text', 275) ?>
	...
	<section class="page-content-section information-blocks">
		...
		<div class="wrap">
			...
			<div class="flex-container shadow">
				...
				<?php foreach( get_field('information_blocks', 275) as $puff ) { ?>
	...
	<section class="page-content-section text-field center">
		...
		<div class="wrap">
			...
			<div class="text-field__content max-width">
				...
				<?php if( get_field('text_field_headline', 275) ) { ?>
				
					<h2 class="text-field__content__headline"><?= get_field('text_field_headline', 275) ?></h2>
					
				<?php } ?>
				
				<?php if( get_field('text_field_text', 275) ) { ?>
				
					<div class="text-field__content__text"><?= get_field('text_field_text', 275) ?></div>
...
<?php if( get_field('left_headline', 275) ) { ?> 
	...
	<section class="page-content-section half-blocks">	
		...
		<div class="wrap">
			...
			<div class="half-blocks__content">
				...
				<?php if( get_field('left_headline', 275) ) { ?>
					<h2 class="half-blocks__content__headline"><?= get_field('left_headline', 275) ?></h2>
				<?}?>
			
				<?php if( get_field('left_text', 275) ) { ?>
					<div class="half-blocks__content__text"><?= get_field('left_text', 275) ?></div>
				<?}?>
			...
			<div class="half-blocks__content">
				...
				<?php if( get_field('right_headline', 275) ) { ?>
					<h2 class="half-blocks__content__headline"><?= get_field('right_headline', 275) ?></h2>
				<?}?>
			
				<?php if( get_field('left_text', 275) ) { ?>
					<div class="half-blocks__content__text"><?= get_field('right_text', 275) ?></div>
				<?}?>
...
<?php if( get_field('half_blocks', 275) ) { ?> 
	
	<?php foreach(get_field('half_blocks', 275) as $post ) { ?> 			
...
<?php if( get_field('pdf', 275) ) { ?> 

	<section class="page-content-section pdfs blue-bg white-font center">
		
		<div class="wrap">
			
			<?php if( get_field('pdf_headline', 275) ) { ?>
			
				<h2 class="pdfs__headline"><?= get_field('pdf_headline', 275) ?></h2>
			...
			<div class="flex-container">
				...
				<?php foreach( get_field('pdf', 275) as $pdf ) { ?>
		...
		<section class="page-content-section half-blocks">
			...
			<div class="wrap">
				...
				<div class="half-blocks__content">
					...
					<?php if(get_field('textblock_text', $post->ID)) { ?>
					
						<div class="half-blocks__content__text">
						
							<?= get_field('intro_text_for_archive', $post->ID) ?>
