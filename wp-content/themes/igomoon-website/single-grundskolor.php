...
add_action('genesis_site_title', function () {
	...
	if( get_field('header_text') ) :
		...
		<span class="school-header-text">
		
			<?= get_field('header_text') ?>
			
			<?php
			
			if( get_field('extra_header_text') ) :
		
				?>
			
				- <?= get_field('extra_header_text') ?>
				...
				<div class="top-image-content wrap center">
					...
					<?php if(get_field('top_image_cta_link') ) { ?>
						...
						<div class="top-field__inner__content__ctas">
							...
							<a class="call-to-action__dark top-field__inner__content__cta" href="<?= get_field('top_image_cta_link') ?>">
								
								<?= get_field('top_image_cta_text') ?>
...
-->
	...
	<section class="page-content-section text-field center white-font turquoise-bg hidden-field hide-in-mobile show-information">
		...
		<div class="wrap">
			...
			<div class="contact-field__content max-width">
				...
				<?php } else { ?>	
					...
					<h2 class="contact-field__content__headline">Ansök till <?= the_title() ?></h2>
	...
	<section class="page-content-section address center">
		...
		<div class="wrap">
			...
			<div class="contact-address__headline">
				...
				<h2><?= get_field('contact_address_headline')?></h2>
